...
public class MimeTypes {
  ...
  static 
  {
    ...
    for ( Entry<String, String> entry : mimeTypeMapping.entrySet()) {
          extMapping.put(entry.getValue(), entry.getKey());
    }
  ...
  /**
   * Returns the corresponding extension from the MIME type.
   */
